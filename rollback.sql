...
delete from test.t1 where age=10,id=6;
...
insert into test.t1 set age=99,id=5;
...
update test.t1 set age=10,id=6 where age=90,id=6;
...
delete from test.t2 where home='12',id=1;
...
delete from test.t2 where home='here',id=2;
...
delete from test.t2 where home='wang',id=3;
...
delete from test.t2 where home='longze',id=4;
